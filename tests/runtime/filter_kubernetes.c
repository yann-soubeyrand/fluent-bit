...
{
    flb_test_annotations_parser("annotations-parser_regex-without-time_text", NULL, 1);
}
...
{
    flb_test_annotations_parser("annotations-parser_regex-with-time_invalid-text-2", NULL, 1);
}

static void flb_test_annotations_parser_json_without_time_json()
{
    flb_test_annotations_parser("annotations-parser_json-without-time_json", NULL, 1);
}
...
{
    flb_test_annotations_parser("annotations-parser_json-with-time_invalid-json-2", NULL, 1);
}
